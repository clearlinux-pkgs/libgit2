...
Source0  : https://github.com/libgit2/libgit2/archive/v1.4.3/libgit2-1.4.3.tar.gz
...
%prep
%setup -q -n libgit2-1.4.3
cd %{_builddir}/libgit2-1.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649980075
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libgit2-1.4.3/deps/http-parser/COPYING %{buildroot}/usr/share/package-licenses/libgit2/1a00a507fb89bb0018c092d6835077d541e76dc2
cp %{_builddir}/libgit2-1.4.3/deps/pcre/LICENCE %{buildroot}/usr/share/package-licenses/libgit2/11ff082389982b8168263850db69199065f2028d
cp %{_builddir}/libgit2-1.4.3/deps/pcre/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libgit2/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/libgit2-1.4.3/deps/winhttp/COPYING.GPL %{buildroot}/usr/share/package-licenses/libgit2/302250717721b22e804054f10e5a8d9c6e7328c4
cp %{_builddir}/libgit2-1.4.3/deps/winhttp/COPYING.LGPL %{buildroot}/usr/share/package-licenses/libgit2/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/libgit2-1.4.3/deps/zlib/COPYING %{buildroot}/usr/share/package-licenses/libgit2/07821586dcc816d67ff045b9708fe8291fd67e62
cp %{_builddir}/libgit2-1.4.3/examples/COPYING %{buildroot}/usr/share/package-licenses/libgit2/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libgit2.so.1.4
/usr/lib64/libgit2.so.1.4.3
