...
%prep
%setup -q -n libgit2-1.8.1
cd %{_builddir}/libgit2-1.8.1
pushd ..
cp -a libgit2-1.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720050880
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libgit2-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libgit2/9a0a8b6f2c5267ea07842ac3f19fde2c85793606 || :
cp %{_builddir}/libgit2-%{version}/deps/llhttp/LICENSE-MIT %{buildroot}/usr/share/package-licenses/libgit2/f7eb77642fea2d18bc5b53d361802ca0fb698b3e || :
cp %{_builddir}/libgit2-%{version}/deps/pcre/LICENCE %{buildroot}/usr/share/package-licenses/libgit2/936db4f914d8b9a516ac93a3bf7856c8bfeb6855 || :
...
cp %{_builddir}/libgit2-%{version}/deps/zlib/LICENSE %{buildroot}/usr/share/package-licenses/libgit2/233f44af3fb55dcc7fddfef8e77ac627b0008756 || :
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgit2.so.1.8.1
/usr/lib64/libgit2.so.1.8
/usr/lib64/libgit2.so.1.8.1

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/libgit2/01a6b4bf79aca9b556822601186afab86e8c4fbf
/usr/share/package-licenses/libgit2/233f44af3fb55dcc7fddfef8e77ac627b0008756
...
/usr/share/package-licenses/libgit2/936db4f914d8b9a516ac93a3bf7856c8bfeb6855
/usr/share/package-licenses/libgit2/9a0a8b6f2c5267ea07842ac3f19fde2c85793606
/usr/share/package-licenses/libgit2/f7eb77642fea2d18bc5b53d361802ca0fb698b3e
